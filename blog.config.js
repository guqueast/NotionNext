...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '去雨曲', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一曲新词酒一杯', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://adagio.icu', // 网站地址
